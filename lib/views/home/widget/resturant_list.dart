import 'package:food_delivery/views/home/models/resturant.dart';

class ResturantList {
  List<Resturant> restureant = [
    Resturant(imagePath: 'assets/images/Resturant_Image2.png', name: 'Vegan Resto', time: '12',),
    Resturant(imagePath: 'assets/images/Restaurant_Image1.png', name: 'Vegan Resto', time: '8',),

        ...
        children: [
          ...
          Padding(
            ...
            child: Container(
              ...
              child: const Center(
                  child: Image(image: AssetImage('assets/icons/Path.png'))),
            ),
          ),
          Stack(
            children: [
              const Padding(
                ...
                child: Image(image: AssetImage('assets/images/Car_track.png')),
              ),
              const Padding(
              ...
              Padding(
                ...
                child: Row(
                  children: const [
                    Image(image: AssetImage('assets/icons/Icon_clock.png')),
                    SizedBox(
                      width: 5,
                    ),
                    Text('25 min',
                        style: TextStyle(
                            fontFamily: 'BentonSans_Book', fontSize: 15))
                  ],
                ),
              ),
              Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image: AssetImage("assets/images/PatternP.png"),
                        fit: BoxFit.cover,
                        // opacity: 10,
                      ),
                    ),
